        ...
        <div class="float-right h-auto d-flex">
            <div class="user-dropdown">
                ...
                <div class="user-dropdown-content ">
                    ...
                    <a href="{{url("/logout")}}" class="side-bar-item" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="#" class="side-bar-item">
        ...
        <span class="side-bar-item-caption">User Dashboard</span>
    </a>
    ...
    <a href="#" class="side-bar-item">
        ...
        <span class="side-bar-item-caption">Wallet</span>
    </a>
